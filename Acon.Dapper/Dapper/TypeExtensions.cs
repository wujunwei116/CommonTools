...
namespace Dapper
{
    ...
    {
        public static string Name(this Type type) { return
        ...
        public static bool IsValueType(this Type type) { return
#if NETSTANDARD1_3 || NETCOREAPP1_0
        ...
        public static bool IsEnum(this Type type){ return
#if NETSTANDARD1_3 || NETCOREAPP1_0
        ...
        public static bool IsGenericType(this Type type) { return
#if NETSTANDARD1_3 || NETCOREAPP1_0
        ...
        public static bool IsInterface(this Type type) { return
#if NETSTANDARD1_3 || NETCOREAPP1_0
...
#else
        public static TypeCode GetTypeCode(Type type) { return Type.GetTypeCode(type); }
#endif
