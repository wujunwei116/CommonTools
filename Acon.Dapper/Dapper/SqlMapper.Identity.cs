...
namespace Dapper
{
    public static partial class SqlMapper
    {
        ...
        {
            internal Identity ForGrid(Type primaryType, int gridIndex) { return
                new Identity(sql, commandType, connectionString, primaryType, parametersType, null, gridIndex);}

            internal Identity ForGrid(Type primaryType, Type[] otherTypes, int gridIndex) { return
            ...
            /// <returns></returns>
            public Identity ForDynamicParameters(Type type){ return
